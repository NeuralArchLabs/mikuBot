...
export const toHtml = (md: string): string => {
    ...
    html = html
        .replace(/<details/g, 'ÔÇ╣details')
        .replace(/<\/details>/g, 'ÔÇ╣/detailsÔÇ║')
        .replace(/<summary>/g, 'ÔÇ╣summaryÔÇ║')
        .replace(/<\/summary>/g, 'ÔÇ╣/summaryÔÇ║');
    ...
    html = html
        .replace(/ÔÇ╣details/g, '<details')
        .replace(/ÔÇ╣\/detailsÔÇ║/g, '</details>')
        .replace(/ÔÇ╣summaryÔÇ║/g, '<summary>')
        .replace(/ÔÇ╣\/summaryÔÇ║/g, '</summary>');
