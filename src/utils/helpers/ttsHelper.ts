...
export function cleanTtsText(text: string, lang: string = 'es'): string {
    ...
    if (lang.toLowerCase().startsWith('es')) {
        const SPANISH_PHONETIC_DICT: Record<string, string> = {
            "debug": "dibug",
            "debugging": "dibuging",
            "pipeline": "paiplain",
            "pipelines": "paiplains",
            ...
            "timeout": "taimaut",
            "warmup": "uarmap",
            "background": "bacgraund",
            "multithreading": "moltitreding",
            "cpu": "se-pe-u",
            "ram": "ram",
            "ipc": "i-pe-se",
            "ui": "u-i",
            ...
            "stutter": "státer",
            "stuttering": "státering",
            "latency": "leitensi",
            "sweet-spot": "suit-spot",
            "sweet spot": "suit-spot",
            "sweet": "suit",
            "spot": "spot",
            "sliding-window": "slaiding-uindou",
            "sliding window": "slaiding-uindou",
            "window": "uindou",
            "prompt": "prompt",
            "prompts": "prompts",
