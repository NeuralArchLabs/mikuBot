...
export const AGENT_TOOLS: ToolDefinition[] = [
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    source: { type: 'string', description: 'Where to read from. Defaults to "workSpace".', enum: ['workSpace', 'core', 'library', 'extra', 'tools', 'root'] }
                },
                required: ['filename']
            }
        }
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    source: { type: 'string', description: 'Where to save. Defaults to "workSpace".', enum: ['workSpace', 'core', 'library', 'extra', 'tools', 'root'] }
                },
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    source: { type: 'string', description: 'Where the file lives.', enum: ['workSpace', 'core', 'library', 'extra', 'tools', 'root'] }
                },
                required: ['filename']
            }
        }
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    source: { type: 'string', enum: ['workSpace', 'core', 'library', 'extra', 'tools', 'root'], description: 'Reference mount point.' }
                },
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    category: { type: 'string', description: 'SearXena category.', enum: ['general', 'images', 'videos', 'news', 'maps', 'shopping'], default: 'general' },
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Retrieve the next page of results from a previous web_search without repeating the search. Use the search_id and next_offset returned by web_search.',
            parameters: {
                type: 'object',
                properties: {
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    source: { type: 'string', description: 'Where the file lives. Defaults to "workSpace".', enum: ['workSpace', 'core', 'library', 'extra', 'tools', 'root'] }
                },
                required: ['filename']
            }
        }
