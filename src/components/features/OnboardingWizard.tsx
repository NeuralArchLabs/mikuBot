                    ...
                    {step === 7 && (
                        <div className="w-full max-w-6xl space-y-6 animate-premium h-full flex flex-col justify-center py-4 text-white">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                {[
                                    { id: 'gemini', t: 'Google AI', m: 'Gemini', i: './geminiICON.png', url: 'https://aistudio.google.com/', inv: false, hc: 'hover:border-blue-500/40 hover:bg-blue-900/10 hover:shadow-[0_0_40px_-10px_rgba(59,130,246,0.3)]', c: 'blue', desc: 'Rápido y excelente uso general.' },
                                    { id: 'groq', t: 'Groq Cloud', m: 'LPU', i: './groqICON.png', url: 'https://console.groq.com/keys', inv: true, hc: 'hover:border-orange-500/40 hover:bg-orange-900/10 hover:shadow-[0_0_40px_-10px_rgba(249,115,22,0.3)]', c: 'orange', desc: 'Velocidad extrema de respuesta.' },
                                    { id: 'zai', t: 'Z.AI / DS', m: 'Avanzado', i: './zai.png', url: 'https://z.ai/subscribe', inv: true, hc: 'hover:border-violet-500/40 hover:bg-violet-900/10 hover:shadow-[0_0_40px_-10px_rgba(139,92,246,0.3)]', c: 'violet', desc: 'Razonamiento lógico profundo.' },
                                    { id: 'ollama', t: 'Ollama', i: './ollamaICON.webp', url: 'https://ollama.com/download', inv: true, hc: 'hover:border-emerald-500/40 hover:bg-emerald-900/10 hover:shadow-[0_0_40px_-10px_rgba(16,185,129,0.3)]', c: 'emerald', m: 'Local', desc: '100% Privado y gratis.' },
                                ].map(p => (
