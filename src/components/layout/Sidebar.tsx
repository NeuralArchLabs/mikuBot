        ...
        <div className="w-64 bg-slate-900 border-r border-slate-700 flex flex-col h-full shadow-xl z-20">
            <div className="p-6">
                <div className="flex items-center gap-3 mb-8 group cursor-default">
                    <div className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 overflow-hidden border border-slate-700">
