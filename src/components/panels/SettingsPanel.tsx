                ...
                {/* ── Core System Tab ─────────────────────────────────── */}
                {
                    settingsTab === 'core' && (<div className="animate-in fade-in duration-500 space-y-6">
                        ...
                        <div className="space-y-4 pt-4 md:pt-6">
                            ...
                            } ${showOllamaAdvanced ? '' : 'space-y-5'}`}>
                                {/* ── Ollama Advanced Sub-View ──────────────────────── */}
                                {showOllamaAdvanced ? (
                                    <div className="w-full flex flex-col animate-in fade-in slide-in-from-right-5 duration-500">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex justify-between items-start gap-4">
                                                    <div className="flex-1">
                                                        <h3 className="text-sm font-black text-slate-200 uppercase tracking-wider flex items-center gap-2 mb-1">
                                                            <Icon name="brain" className="text-purple-500" /> {i18n.language === 'es' ? 'Pensamiento Extendido' : 'Extended Thinking'}
                                                        </h3>
                                                        <p className="text-xs text-slate-500 font-medium leading-relaxed">
                                                            {i18n.language === 'es'
                                                                ? 'Activa el razonamiento interno en modelos compatibles (ej: deepseek-r1). Muestra el proceso de pensamiento del modelo.'
                                                                : 'Enables internal reasoning on compatible models (e.g., deepseek-r1). Shows the model\'s thinking process.'}
                                                        </p>
                                                    </div>
                                                    <button
