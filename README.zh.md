...
**第三方致谢:**
MikuBot 的实现归功于 React (MIT)、Vite (MIT)、Electron (MIT)、Mermaid.js (MIT)、Tailwind CSS (MIT)、Zustand (MIT)、FastAPI (MIT) 以及 Ollama 和 Google GenAI (Apache 2.0) 等 AI SDKs。有关更多详细信息，请参阅 [`LICENSE`](./LICENSE) 文件。
