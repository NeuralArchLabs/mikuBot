...
人们通常会认为 **MikuBot** 是以著名的虚拟偶像*初音未来 (Hatsune Miku)*命名的。然而，它的起源要个人化得多。这个项目是为了纪念 **Miku**，一只勇敢的小猫（照片中间的那只），在实验室成立初期那些无尽的深夜编程时光里，是她带来了光明和陪伴。
...
从本质上讲，MikuBot 是我们对她忠诚的最深切感激。这是一种技术方式，确保她的名字和遗产继续存在，并跨越主权网络去帮助他人。🤍
