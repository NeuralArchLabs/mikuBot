...
!macro customHeader
  ...
  LangString TIP_ONBOARDING_1 1034 "CONSEJO: Al iniciar, el Onboarding"
  LangString TIP_ONBOARDING_1 3082 "CONSEJO: Al iniciar, el Onboarding"
  LangString TIP_ONBOARDING_2 1034 "te guiará paso a paso para configurar tu Miku."
  LangString TIP_ONBOARDING_2 3082 "te guiará paso a paso para configurar tu Miku."
  LangString TIP_LEARN_1 1034 "MikuCentral puede aprender sobre ti"
  LangString TIP_LEARN_1 3082 "MikuCentral puede aprender sobre ti"
  LangString TIP_LEARN_2 1034 "para ser hiper-específica en sus respuestas."
  LangString TIP_LEARN_2 3082 "para ser hiper-específica en sus respuestas."
  ...
  LangString TIP_ONBOARDING_1 1033 "TIP: Upon launch, Onboarding will guide"
  LangString TIP_ONBOARDING_2 1033 "you step by step to configure your Miku."
  LangString TIP_LEARN_1 1033 "MikuCentral can learn about you to"
  LangString TIP_LEARN_2 1033 "become hyper-specific in its responses."
  ...
  LangString TIP_ONBOARDING_1 2052 "提示：启动后，新手引导将逐步"
  LangString TIP_ONBOARDING_2 2052 "引导您完成 Miku 的配置。"
  LangString TIP_LEARN_1 2052 "MikuCentral 可以了解您，"
  LangString TIP_LEARN_2 2052 "从而使回复变得极具针对性。"
...
Section "-PreInstallSection"
  ...
  DetailPrint "--------------------------------------------------------"
  DetailPrint "$(TIP_ONBOARDING_1)"
  DetailPrint "$(TIP_ONBOARDING_2)"
  DetailPrint "$(TIP_LEARN_1)"
  DetailPrint "$(TIP_LEARN_2)"
  DetailPrint "--------------------------------------------------------"
